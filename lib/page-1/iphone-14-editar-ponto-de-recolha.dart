...
class EditarPonto extends StatelessWidget {
  @override
    ...
    return Scaffold(
      body: SingleChildScrollView(
        child: Container(
          ...
          child: Container(
            // iphone14editarpontoderecolhav2 (81:203)
            width: double.infinity,
            ...
            child: Column(
              ...
              children: [
                Container(
                  // autogroupk9f2Rzc (T2iCGQct4ymjotigd6k9F2)
                  width: double.infinity,
                  height: 273 * fem,
                  child: Stack(
                    children: [
                      Positioned(
                        // rectangle245MtG (81:204)
                        left: 0 * fem,
                        top: 0 * fem,
                        child: Align(
                          child: SizedBox(
                      ...
                      Positioned(
                        // editarpontoderecolharq2 (81:205)
                        left: 57 * fem,
                        top: 95 * fem,
                        child: Align(
                          child: SizedBox(
                                ...
                                child: Container(
                                  decoration: BoxDecoration(
                                    ...
                                    image: DecorationImage(
                                      fit: BoxFit.cover,
                                      image: AssetImage(
                                        'assets/page-1/images/logo-bg-LiQ.png',
                                      ),
                                    ),
                                  ),
                                ),
                ...
                Container(
                  // autogroup3e1axf6 (T2iCTV8kp1bXioSaQU3E1a)
                  padding:
                      EdgeInsets.fromLTRB(2 * fem, 19 * fem, 0 * fem, 0 * fem),
                  width: double.infinity,
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.center,
                    children: [
                      ...
                      Container(
                        // coordenadasiGt (81:232)
                        margin: EdgeInsets.fromLTRB(
                            39 * fem, 0 * fem, 37 * fem, 19 * fem),
                        padding: EdgeInsets.fromLTRB(
                            12 * fem, 15 * fem, 12 * fem, 13 * fem),
                        width: double.infinity,
                        decoration: BoxDecoration(
                      ...
                      Container(
                        // frame457yCp (81:235)
                        margin: EdgeInsets.fromLTRB(
                            39 * fem, 0 * fem, 37 * fem, 241 * fem),
                        padding: EdgeInsets.fromLTRB(
                            12 * fem, 13 * fem, 12 * fem, 15 * fem),
                        width: double.infinity,
                        decoration: BoxDecoration(
                          border: Border.all(color: Color(0xffccc9c9)),
                          color: Color(0xfff8f8f8),
                      ...
                      Container(
                        // botoadicionarpontoRKi (81:223)
                        margin: EdgeInsets.fromLTRB(
                            95 * fem, 0 * fem, 0 * fem, 25 * fem),
                        width: 209 * fem,
                        height: 43 * fem,
                        decoration: BoxDecoration(
